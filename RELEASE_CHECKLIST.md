...
| v2.2.0 | 2026-06-28 | (pending) | Core Flow End-to-End Smoke / Real Vault Flow，验证插件主流程在真实 Vault 中完整可用（自动化测试全绿 + 20 项 manual required 手工验证清单）+ 约束确认(AgentEvent v0.1 未改/sdk-experimental 默认关闭/不绑定固定输出目录/不新增业务模板)，不新增功能，不改 Skills 系统，生成 docs/e2e-smoke-v2.2.md |
