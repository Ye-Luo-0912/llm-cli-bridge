...
| PASS | 恢复会话：Phase 1 创建会话 | threadId=019f5f26-33a7-7532-87a7-07beb5f4b26a |
| PASS | 恢复会话：Phase 2 thread/resume | resumedThreadId=019f5f26-33a7-7532-87a7-07beb5f4b26a |
| PASS | 恢复会话：Phase 2 上下文保留验证 | agentMessage="RESUME_42" |
| PASS | 分叉：turn/started 携带 turn.id（nativeTurnId） | turn.id=019f5f26-916e-74d2-939c-57a6bf9bf129, turnReason=completed |
| PASS | 分叉：thread/fork 接受真实 lastTurnId | fork 成功 |
| PASS | 追加：turn/steer 被接受 | steer RPC 已接受（expectedTurnId=019f5f26-da3c-7bf0-9f74-fd8f32128405） |
