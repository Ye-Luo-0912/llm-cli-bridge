...
- **生成时间**: 2026-07-05T06:50:33.418Z
- **reportCommitSha**: 8ce85e11c323957e9f8a85fc4813b46bc933188d
- **reportCommitSha 短**: 8ce85e11c323
- **reportParentSha**: b757d42a1c3b7909dda480da9cd101786bb23b5b
- **reportParentSha 短**: b757d42a1c3b
- **testedCodeCommitSha**: 8ce85e11c323957e9f8a85fc4813b46bc933188d
- **testedCodeCommitSha 短**: 8ce85e11c323
- **commitKind**: code commit（报告证明当前 HEAD）
- **unitReportCommitSha**: 8ce85e11c323957e9f8a85fc4813b46bc933188d
- **processReportCommitSha**: 8ce85e11c323957e9f8a85fc4813b46bc933188d
...
- **unit 测试时间**: 2026-07-05T06:49:35.815Z
- **process 测试时间**: 2026-07-05T06:50:14.203Z
...
- **本次判定**：code commit（报告证明当前 HEAD）；testedCodeCommitSha=8ce85e11c323。
- **当前 commit 改动文件**：main.ts, scripts/run-tests.mjs, src/agentRuntimeWorkspace.ts, src/runtime/core/bridgeSession.ts, src/runtime/core/types.ts, src/runtime/providers/pi-rpc/piRpcProvider.ts, src/settings.ts, src/types.ts, src/view.ts

## 主线结论

| 轨道 | 通过 | 失败 | 跳过 | 需人工 | 总计 | commit sha | 主线状态 |
|------|------|------|------|--------|------|------------|----------|
| unit | 955 | 0 | 25 | 0 | 980 | 8ce85e11c323 | ✅ 通过 |
| process | 97 | 0 | 56 | 0 | 153 | 8ce85e11c323 | ✅ 通过 |
| codex-smoke | - | - | - | - | - | null | ⏭️ skip |
| **合计** | **1052** | **0** | **81** | **0** | **1133** | 8ce85e11c323 | ✅ **主线通过** |
