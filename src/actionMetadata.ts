...
export const ACTION_METADATA: Record<ActionType, ActionMetadata> = {
  ...
  get_active_note: meta("get_active_note", [],
    "{path, content, size} | null", "获取当前活动笔记全文", "basic"),
  ...
  property_set: meta("property_set",
    [["path", "string", true, "vault 相对路径"], ["key", "string", true, "属性名"], ["value", "unknown", true, "属性值"]],
    "undefined", "写 frontmatter 属性（fileManager.processFrontMatter）", "structured"),
  tags_list: meta("tags_list",
    [["path", "string", false, "目录前缀过滤"]], "string[]", "全 vault 标签清单", "structured"),
  ...
  tasks_list: meta("tasks_list",
    [["path", "string", false, "目录前缀过滤"]], "Array<{path, line, text, checked}>", "待办清单", "structured"),
  ...
  search: meta("search",
    [["query", "string", true, "搜索词（支持正则）"], ["path", "string", false, "目录前缀过滤"], ["limit", "number", false, "结果上限（默认50，上限200）"]],
    "Array<{path, line, match, context}>", "全文搜索（markdown-aware）", "search"),
  ...
  metadatacache_get: meta("metadatacache_get",
    [["path", "string", true, "vault 相对路径"]],
    "{frontmatter, tags, links, embeds, headings, sections}", "单文件完整 metadataCache 快照", "structured"),
  resolved_links_map: meta("resolved_links_map",
    [["path", "string", false, "目录前缀过滤"]], "Record<string, Array<{link, resolved}>>", "全 vault 解析后链接图", "structured"),
